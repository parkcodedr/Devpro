<div class="container">
    ...
    <svg class="page-not-found" viewBox="0 0 1280 1024">
        ...
        <g class="hide words">
            ...
            <text transform="translate(742 682.9)" style="font-size: 60px;fill: #032c3f;font-family: Futura-CondensedMedium, Futura">GO <tspan x="69.1" y="0" style="letter-spacing: 0.0029296875em">B</tspan>
                <tspan x="94" y="0" style="letter-spacing: -0.0068359375em">A</tspan>
                <tspan x="118" y="0">CK</tspan>
            </text>
            <text transform="translate(479.2 549.5)" style="font-size: 180px;fill: #032c3f;font-family: Futura-CondensedExtraBold, Futura;font-weight: 700">4<tspan x="108.3" y="0" style="letter-spacing: -0.0009765625em">0</tspan>
                <tspan x="216.4" y="0">4</tspan>
            </text>
        </g>
    </svg>
</div>
...
<script type="text/javascript">
    var tl = new TimelineMax(),
        split404 = new SplitText(".textB", {
            type: "chars"
        }),
        splitPage = new SplitText(".textA", {
            type: "chars"
        }),
        splitBack = new SplitText(".textC", {
            type: "chars"
        });
    ...
    tl.set(".hide", {
        ...
        .set(".hide.big-white-circle", {
            scale: 0,
            transformOrigin: "50% 50%"
        })
        .set(".hide.bottom-triangles", {
            scale: 0,
            rotation: 720,
            transformOrigin: "50% 50%"
        })
        ...
        .staggerFrom(split404.chars, 1, {
            opacity: 0,
            scaleX: 0,
            ease: Power4.easeOut
        }, 0.05, "-=1")
        .staggerTo(split404.chars, 1, {
            opacity: 1,
            scaleX: 1,
            ease: Power4.easeOut
        }, 0.05, "-=1")

        .staggerFrom(splitPage.chars, 1, {
            opacity: 0,
            scaleX: 0,
            ease: Power4.easeOut
        }, 0.05, "-=1")
        .staggerTo(splitPage.chars, 1, {
            opacity: 1,
            scaleX: 1,
            ease: Power4.easeOut
        }, 0.05, "-=1")

        .staggerFrom(splitBack.chars, 1, {
            opacity: 0,
            scaleX: 0,
            ease: Power4.easeOut
        }, 0.05, "-=1.5")
        .staggerTo(splitBack.chars, 1, {
            opacity: 1,
            scaleX: 1,
            ease: Power4.easeOut
        }, 0.05, "-=1.5")
        .to(".hide.big-white-circle", 2, {
            scale: 1,
            opacity: 1,
            ease: Elastic.easeOut.config(1, 0.3)
        }, "-=1.45")
        .to(".hide.spin-circles", 2, {
            opacity: 1
        }, "-=1.45")
        .to(".hide.tri-dots", 1, {
            opacity: 1
        }, "-=1.5")
        .to(".hide.bottom-triangles", 2, {
            opacity: 1,
            scale: 1,
            rotation: 0
        }, "-=1.5")
    ...
    tlSpin.set('.hide.spin-circles', {
            rotation: 0,
            transformOrigin: "50% 50%"
        })
        .to('.hide.spin-circles', 3.5, {
            rotation: 360,
